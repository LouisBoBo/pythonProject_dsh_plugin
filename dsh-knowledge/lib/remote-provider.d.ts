import type { CandidateProposal, CandidateBatchReviewResult, ExtractionJobCompletion, ExtractionJobRecord, KnowledgeCandidate, KnowledgeBase, KnowledgeBaseDraft, KnowledgeBasePatch, KnowledgeDraft, KnowledgeEntry, KnowledgeDocument, KnowledgeDocumentIndexRequest, KnowledgeDocumentIndexResult, KnowledgeStats, KnowledgeVersion, KnowledgeMount, KnowledgeMountBatch, KnowledgeMountBatchResult, KnowledgeMountDraft, KnowledgeMountTargetKind, KnowledgeSettings, KnowledgeSettingsPatch, ResolvedKnowledgeMount, DirectWriteResult, ListRequest, ListResult, ReviewDecision, SearchHit, SearchRequest } from './domain.js';
...
export declare class RemoteKnowledgeProvider implements KnowledgeProvider {
    ...
    readNote(id: string, signal?: AbortSignal): Promise<{
        node: NoteNode;
        content: Uint8Array;
    }>;
    listNoteVersions(id: string, limit?: number, signal?: AbortSignal): Promise<NoteVersion[]>;
    readNoteVersion(id: string, version: number, signal?: AbortSignal): Promise<{
        node: NoteNode;
        version: NoteVersion;
        content: Uint8Array;
    }>;
    ...
    addKnowledgeNoteReference(knowledgeId: string, noteId: string, source: KnowledgeNoteReferenceSource, sourceSessionId?: string, signal?: AbortSignal): Promise<KnowledgeNoteReference>;
    ...
    writebackProtocol(signal?: AbortSignal): Promise<{
...
export declare class RemoteProviderError extends Error {
