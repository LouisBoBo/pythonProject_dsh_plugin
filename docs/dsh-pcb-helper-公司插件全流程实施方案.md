...
./scripts/internal-market/[pack.sh](http://pack.sh) dsh-remote-review

./scripts/internal-market/ [upload.sh](http://upload.sh)

./scripts/internal-market/[install-latest.sh](http://install-latest.sh) dsh-remote-review
